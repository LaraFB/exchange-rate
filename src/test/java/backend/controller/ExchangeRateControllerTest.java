...
class ExchangeRateControllerTest {
    ...
    class GetExchangeRateTests {
        ...
        void badRequest() throws Exception {
            ...
            mockMvc.perform(post("/api/exchange-rate").contentType(MediaType.APPLICATION_JSON).content("{\"fromCurrency\":null,\"toCurrency\":\"EUR\"}"))
    ...
    class GetAllRatesTests {
        ...
        void success() throws Exception {
            ...
            mockMvc.perform(get("/api/rates").param("currency", "USD"))
                    .andExpect(status().isOk())
        ...
        void badRequest() throws Exception {
            ...
            mockMvc.perform(get("/api/rates").param("currency", ""))
                    .andExpect(status().isBadRequest())
